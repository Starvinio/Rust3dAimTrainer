...
impl Scenario {
    ...
    fn close_strafes_invincible() -> Self {
        Scenario {
...
fn load_all_scenarios() -> Vec<Scenario> {
...
fn static_clicking() -> Vec<Scenario> {
    vec![
        Scenario::jumbo_tf(),
        Scenario::jumbo_flat(),
        Scenario::mini_tf(),
...
fn reactive_tracking() -> Vec<Scenario> {
    vec![
...
fn precise_tracking() -> Vec<Scenario> {
    vec![
        Scenario::smooth_strafes_invincible(),
    ]
}

fn speed_switching() -> Vec<Scenario> {
    vec![
        Scenario::ww_6t_s_ts(),
    ]
}

fn evasive_switching() -> Vec<Scenario> {
    vec![
        Scenario::control_ts(),
    ]
}
